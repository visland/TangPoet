...
export default class Home extends Component {
  ...
  componentWillMount(){
    this.titleContent = [
      { "title": "一抹倩影，写就传奇", "info": "悠悠千年间，文人墨客为抒其志，挥笔写就众多名作佳篇，然其皎皎者，多为男子。女性或锁于深闺，缺少见闻，或屏息敛气，惟命是从，囿于米盐琐屑。中国千年的文学长河中，难以寻觅女性身影。然唐历盛世之治，世风开放，文化繁荣，女子允许识经史，作诗文，加之初唐时期武则天颁布一系列政令措施，肯定女性价值，使得唐朝的女性诗歌创作达到了前所未有的高度。她们中有女皇、后妃、女官、宫娥、娟尼、蟀妾、名媛、闺秀，尽管身份不同，地位不同，却构成了一个五光十色、争奇斗妍的女性诗苑。让我们重新翻开历史的画卷，去寻那一抹丽色，品一品千年前的别样传奇。" },
      { "title": "一声轻叹，倾诉相思", "info": "“诗缘情而绮靡”，她们以笔书情、以诗言志；她们在诗中书写对真挚爱情的渴望、对自主婚姻的追求；抒发对时事政治的所思所感，对自身怀才不遇的哀叹。那些诗行，不仅浸润了她们的缱绻柔情，亦写就了她们的豪情壮志。"},
