...
export default class Home extends Component {
  constructor() {
    super();
    this.info = ["悠悠千年间，文人墨客为抒其志，挥笔写就众多名作佳篇，然其皎皎者，多为男子。女性或锁于深闺，缺少见闻，或屏息敛气，惟命是从，囿于米盐琐屑。中国千年的文学长河中，难以寻觅女性身影。", 
    "悠悠千年间，文人墨客为抒其志，挥笔写就众多名作佳篇，然其皎皎者，多为男子。女性或锁于深闺，缺少见闻，或屏息敛气，惟命是从，囿于米盐琐屑。中国千年的文学长河中，难以寻觅女性身影。"]
  }
  componentWillMount(){
    this.titleContent = [
