...
export default class Home extends Component {
  ...
  "时光荏苒，中秋又至，人们或在月下独酌，邀月共饮，或吟诗诵曲以遣怀抒情。天边那轮明月横亘古今，连接了千年的思念——人们记得男性诗人笔下的松间明月、床前月光，却少有人知道女诗人也曾写下“离人无语月无声，明月有光人有情”这样的佳句。"]
  }
  componentWillMount(){
    this.titleContent = [
      { "title": "一抹倩影，写就传奇", "info": "唐历盛世之治，世风开放，文化繁荣，女子允许识经史，作诗文，加之初唐时期武则天颁布一系列政令措施，肯定女性价值，使得唐朝的女性诗歌创作达到了前所未有的高度。<br>纵观唐代文学史，男性诗人仍占领着绝对优势，女诗人的所有诗作，数量加起来不及白居易的三分之一，不足总量的千分之一。“女子作诗，其工也，难于男子；闺秀之名，其传也，亦难于才士。”写诗不易，存诗愈难。女性诗人平均每人作诗四首，多数仅有一篇诗作流传下来，其中写诗小能手薛涛一人独做九十三首，为唐代女诗人之首。" },
  ...
  render() {
    return (
      <div className="bg">
        <LeadIn />
        <p className='title-info'>{ this.info[2] }</p>
        {/* 第一部分 */}
